...
public final class UnsafeExternalSorter extends MemoryConsumer {
    ...
    taskContext.addTaskCompletionListener(
      new TaskCompletionListener() {
        ...
        public void onTaskCompletion(TaskContext context) {
          // [Hack]: victor - disable cleanupResources onTaskCompletion as sorter may be reused across tasks
          // cleanupResources();
        }
      }
    );
  ...
  public long spill(long size, MemoryConsumer trigger) throws IOException {
    if (true) {
      throw new RuntimeException("spill is not supported!");
    }
    ...
    logger.warn("Thread {} spilling sort data of {} to disk ({} {} so far)",
  ...
  // victor
  public UnsafeSorterIterator getSortedIterator(boolean sorted) throws IOException {
    if (sorted) {
      return inMemSorter.getSortedIteratorWithoutSorting();
    } else {
