...
public class TaskMemoryManagerSuite {
  ...
  @Test
  public void leakedPageMemoryIsDetected() throws Exception {
  ...
  @Test
  public void encodePageNumberAndOffsetOffHeap() throws Exception {
  ...
  @Test
  public void encodePageNumberAndOffsetOnHeap() throws Exception {
    final TaskMemoryManager manager = new TaskMemoryManager(
  ...
  @Test
  public void cooperativeSpilling() throws Exception {
  ...
  @Test
  public void shouldNotForceSpillingInDifferentModes() throws Exception {
    final TestMemoryManager memoryManager = new TestMemoryManager(new SparkConf());
    memoryManager.limit(100);
    final TaskMemoryManager manager = new TaskMemoryManager(memoryManager, 0);
  ...
  @Test
  public void offHeapConfigurationBackwardsCompatibility() throws Exception {
