...
public class LongKeyBPlusTreeSecondaryIndexLeaf 
	extends BPlusTreeSecondaryIndexLeaf<LongKeyBPlusTreeSecondaryIndexLeaf> 
	implements LongKeyBPlusTreeSecondaryIndexPage, Serializable {
	private static final long serialVersionUID = 1L;
		
	private long[] keys;
		
	public LongKeyBPlusTreeSecondaryIndexLeaf(int nodeSize) {
		super(nodeSize, 8);
	...
	public void insert(long key, int data, LongKeyBPlusTreeSecondaryIndexResult result) {				
		int i;		
	...
	private LongKeyBPlusTreeSecondaryIndexPage split() {
		LongKeyBPlusTreeSecondaryIndexLeaf rightLeaf = new LongKeyBPlusTreeSecondaryIndexLeaf(this.nodeSize);
