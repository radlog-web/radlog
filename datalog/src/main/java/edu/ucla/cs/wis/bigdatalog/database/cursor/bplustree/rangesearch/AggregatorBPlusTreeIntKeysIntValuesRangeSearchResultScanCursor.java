...
public class AggregatorBPlusTreeIntKeysIntValuesRangeSearchResultScanCursor 
	extends AggregatorBPlusTreeIntKeysRangeSearchResultScanCursor<AggregatorBPlusTreeIntKeysIntValuesLeaf> {

	protected int[] values;

	public AggregatorBPlusTreeIntKeysIntValuesRangeSearchResultScanCursor(AggregateRelation relation) {
		super(relation);
	}
...
*/
	...
	public int loadTuple(Tuple tuple) {
		return ((AggregatorBPlusTreeIntKeysIntValues)this.storageStructure).loadTuple(this.currentKey, this.values[this.keyIndex], tuple);
	}
