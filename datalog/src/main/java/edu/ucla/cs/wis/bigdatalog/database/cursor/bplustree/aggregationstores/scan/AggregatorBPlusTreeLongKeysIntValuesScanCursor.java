...
public class AggregatorBPlusTreeLongKeysIntValuesScanCursor 
	extends AggregatorBPlusTreeStoreScanCursor<AggregatorBPlusTreeLongKeysIntValues, AggregatorBPlusTreeLongKeysIntValuesLeaf> {

	protected long[] keys;
	protected int[] values;

	public AggregatorBPlusTreeLongKeysIntValuesScanCursor(AggregateRelation relation) {
		super(relation);
	}
