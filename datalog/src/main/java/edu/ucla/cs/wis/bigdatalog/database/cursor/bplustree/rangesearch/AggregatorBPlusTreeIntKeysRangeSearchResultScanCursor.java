...
abstract public class AggregatorBPlusTreeIntKeysRangeSearchResultScanCursor<L extends BPlusTreeLeaf<?>>
	extends AggregatorBPlusTreeRangeSearchResultScanCursor<L, Integer, int[]> {

	protected AggregatorBPlusTreeIntKeysRangeSearchResultScanCursor(Relation<Tuple> relation) {
		super(relation);
	}
