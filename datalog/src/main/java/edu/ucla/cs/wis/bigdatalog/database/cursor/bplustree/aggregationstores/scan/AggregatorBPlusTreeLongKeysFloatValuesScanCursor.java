...
public class AggregatorBPlusTreeLongKeysFloatValuesScanCursor extends
		AggregatorBPlusTreeStoreScanCursor<AggregatorBPlusTreeLongKeysFloatValues, AggregatorBPlusTreeLongKeysFloatValuesLeaf> {

	protected long[] keys;
	protected double[] values;
	
	public AggregatorBPlusTreeLongKeysFloatValuesScanCursor(AggregateRelation relation) {
		super(relation);
	}
