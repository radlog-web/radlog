...
public class AggregatorBPlusTreeIntKeysDbTypeDbKeyValuesRangeSearchResultScanCursor 
	extends AggregatorBPlusTreeIntKeysRangeSearchResultScanCursor<AggregatorBPlusTreeIntKeysDbTypeDbKeyValuesLeaf>{

	protected DbTypeBase[] totalValues;
	protected DbKeyValueStore[] keyValues;
		
	public AggregatorBPlusTreeIntKeysDbTypeDbKeyValuesRangeSearchResultScanCursor(AggregateRelation relation) {
		super(relation);
	}
...
*/
	...
	public int loadTuple(Tuple tuple) {
		return ((AggregatorBPlusTreeIntKeysDbTypeDbKeyValues)this.storageStructure).loadTuple(this.currentKey, 
				this.totalValues[this.keyIndex], this.keyValues[this.keyIndex], tuple);
	}
