...
public class BPlusTreeByteKeysOnlyNode 
	...
	public BPlusTreeByteKeysOnlyNode() { super(); }
	
	public BPlusTreeByteKeysOnlyNode(BPlusTreeByteKeysOnly tree) {
	...
	private BPlusTreeByteKeysOnlyPage split() {
		BPlusTreeByteKeysOnlyNode rightNode = new BPlusTreeByteKeysOnlyNode(this.tree);
