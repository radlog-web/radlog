...
public class AggregatorBPlusTreeForestLongKeysIntValuesScanCursor 
	...
	public AggregatorBPlusTreeForestLongKeysIntValuesScanCursor(AggregateRelation relation) {
		super(relation);
	}
