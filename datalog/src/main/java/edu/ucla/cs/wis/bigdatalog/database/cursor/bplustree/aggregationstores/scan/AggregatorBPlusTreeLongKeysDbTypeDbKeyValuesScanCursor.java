...
public class AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesScanCursor 
	extends AggregatorBPlusTreeStoreScanCursor<AggregatorBPlusTreeLongKeysDbTypeDbKeyValues, AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesLeaf> {

	protected long[] keys;
	protected DbTypeBase[] totalValues;
	protected DbKeyValueStore[] keyValues;
	
	public AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesScanCursor(AggregateRelation relation) {
		super(relation);
	}
