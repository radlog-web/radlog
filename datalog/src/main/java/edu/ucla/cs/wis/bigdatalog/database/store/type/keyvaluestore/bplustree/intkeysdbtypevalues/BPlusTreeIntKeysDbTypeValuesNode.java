...
public class BPlusTreeIntKeysDbTypeValuesNode 
	extends BPlusTreeNode<BPlusTreeIntKeysDbTypeValuesPage, BPlusTreeIntKeysDbTypeValuesLeaf>
	implements BPlusTreeIntKeysDbTypeValuesPage, Serializable {
	private static final long serialVersionUID = 1L;

	protected long[] keys;
	
	public BPlusTreeIntKeysDbTypeValuesNode() { super(); } 
	
	public BPlusTreeIntKeysDbTypeValuesNode(int nodeSize) {
		super(nodeSize, 4);
		
		this.keys = new long[this.numberOfKeys]; // M-1 keys
		this.children = new BPlusTreeIntKeysDbTypeValuesPage[this.getBranchingFactor()]; // M children
	...
	private BPlusTreeIntKeysDbTypeValuesPage split() {
		BPlusTreeIntKeysDbTypeValuesNode rightNode = new BPlusTreeIntKeysDbTypeValuesNode(this.nodeSize);
