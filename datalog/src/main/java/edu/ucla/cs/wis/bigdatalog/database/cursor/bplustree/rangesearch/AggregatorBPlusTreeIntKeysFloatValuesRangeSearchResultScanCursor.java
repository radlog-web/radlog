...
import edu.ucla.cs.wis.bigdatalog.database.store.aggregators.bplustree.intkeysfloatvalues.AggregatorBPlusTreeIntKeysFloatValuesLeaf;

public class AggregatorBPlusTreeIntKeysFloatValuesRangeSearchResultScanCursor 
	extends AggregatorBPlusTreeIntKeysRangeSearchResultScanCursor<AggregatorBPlusTreeIntKeysFloatValuesLeaf> {

	protected double[] values;

	public AggregatorBPlusTreeIntKeysFloatValuesRangeSearchResultScanCursor(AggregateRelation relation) {
		super(relation);
	}
...
/*
	...
	*/
	...
	public int loadTuple(Tuple tuple) {
		return ((AggregatorBPlusTreeIntKeysFloatValues)this.storageStructure).loadTuple(this.currentKey, this.values[this.keyIndex], tuple);
	}
