...
public class BPlusTreeLongKeysOnlyTwoLevelNode 
	extends BPlusTreeNode<BPlusTreeLongKeysOnlyTwoLevelPage, BPlusTreeLongKeysOnlyTwoLevelLeaf> 
	implements BPlusTreeLongKeysOnlyTwoLevelPage, Serializable {
	private static final long serialVersionUID = 1L;

	protected int[] keys;
	
	public BPlusTreeLongKeysOnlyTwoLevelNode() { super(); }
	
	public BPlusTreeLongKeysOnlyTwoLevelNode(int nodeSize) {
		super(nodeSize, 4);
		
		this.keys = new int[this.numberOfKeys]; // M-1 keys
		this.children = new BPlusTreeLongKeysOnlyTwoLevelPage[this.getBranchingFactor()]; // M children
	...
	public void insert(long key, BPlusTreeLongKeysOnlyTwoLevelInsertResult result, TypeManager typeManager) {
		...
		this.children[insertAt].insert(key, result, typeManager);
	...
	private BPlusTreeLongKeysOnlyTwoLevelPage split() {
		BPlusTreeLongKeysOnlyTwoLevelNode rightNode = new BPlusTreeLongKeysOnlyTwoLevelNode(this.nodeSize);
