...
public class LongKeyBPlusTreeSecondaryIndexNode 
	extends BPlusTreePage 
	implements LongKeyBPlusTreeSecondaryIndexPage {
	private static final long serialVersionUID = 1L;

	protected long[] keys;
	protected LongKeyBPlusTreeSecondaryIndexPage[] children;
	
	public LongKeyBPlusTreeSecondaryIndexNode(int nodeSize) {
		super(nodeSize, 8);
	...
	protected void initialize() {
		...
		this.children = new LongKeyBPlusTreeSecondaryIndexPage[this.getBranchingFactor()]; // M children
	}
	...
	private LongKeyBPlusTreeSecondaryIndexPage split() {
		LongKeyBPlusTreeSecondaryIndexNode rightNode = new LongKeyBPlusTreeSecondaryIndexNode(this.nodeSize);
	...
	public LongKeyBPlusTreeSecondaryIndexLeaf getFirstChild() {
		...
		if (this.getHeight() > 1)
			return ((LongKeyBPlusTreeSecondaryIndexNode)this.children[0]).getFirstChild();
		
		return (LongKeyBPlusTreeSecondaryIndexLeaf) this.children[0];
	}
	...
	public MemoryMeasurement getSizeOf() {
		...
		int allocated = 0;
		if (this.keys != null) {
			used += this.highWaterMark * 8; // 8 bytes per integer
