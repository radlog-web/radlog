...
public class AggregatorBPlusTreeIntKeysFloatValuesScanCursor extends
		AggregatorBPlusTreeStoreScanCursor<AggregatorBPlusTreeIntKeysFloatValues, AggregatorBPlusTreeIntKeysFloatValuesLeaf> {

	protected int[] keys;
	protected double[] values;
	
	public AggregatorBPlusTreeIntKeysFloatValuesScanCursor(AggregateRelation relation) {
		super(relation);
	}
