...
import edu.ucla.cs.wis.bigdatalog.database.store.aggregators.bplustree.longkeysfloatvalues.AggregatorBPlusTreeLongKeysFloatValuesLeaf;

public class AggregatorBPlusTreeLongKeysFloatValuesRangeSearchResultScanCursor 
	extends AggregatorBPlusTreeLongKeysRangeSearchResultScanCursor<AggregatorBPlusTreeLongKeysFloatValuesLeaf>{

	protected double[] values;

	public AggregatorBPlusTreeLongKeysFloatValuesRangeSearchResultScanCursor(AggregateRelation relation) {
		super(relation);
	}
...
/*
	...
	protected int loadTuple(Tuple tuple) {
		return ((AggregatorBPlusTreeLongKeysFloatValues)this.storageStructure).loadTuple(this.currentKey, this.values[this.keyIndex], tuple);
	}
