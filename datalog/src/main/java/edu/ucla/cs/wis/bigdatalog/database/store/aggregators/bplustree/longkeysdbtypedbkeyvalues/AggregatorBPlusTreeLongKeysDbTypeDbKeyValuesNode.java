...
public class AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesNode
	extends AggregatorBPlusTreeNode<AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesPage, AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesLeaf> 
	...
	public AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesNode() { super(); }
	
	public AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesNode(int nodeSize, DataType totalValueType, 
			DataType keyValueType, AggregateFunctionType aggregateType) {
		super(nodeSize, 8, aggregateType);
		...
		this.children = new AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesPage[this.getBranchingFactor()]; // M children
	...
	@Override
	public void insert(long key, DbTypeBase subKey, DbNumericType value, AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesResult result, 
	...
	private AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesPage split() {
		AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesNode rightNode = 
				new AggregatorBPlusTreeLongKeysDbTypeDbKeyValuesNode(this.nodeSize, this.totalValueType, 
