...
public class BPlusTreeIntKeysTupleValuesLeaf 
	extends BPlusTreeLeaf<BPlusTreeIntKeysTupleValuesLeaf> 
	implements BPlusTreeIntKeysTupleValuesPage, BPlusTreeTupleStoreLeaf, Serializable {
	private static final long serialVersionUID = 1L;
	
	protected int[] keys;
	protected ArrayList<Tuple>[] tuples;
	
	public BPlusTreeIntKeysTupleValuesLeaf() { super(); }
	
	public BPlusTreeIntKeysTupleValuesLeaf(int nodeSize) {
		super(nodeSize, 4);
	...
	private BPlusTreeIntKeysTupleValuesPage split() {
		BPlusTreeIntKeysTupleValuesLeaf rightLeaf = new BPlusTreeIntKeysTupleValuesLeaf(this.nodeSize);
