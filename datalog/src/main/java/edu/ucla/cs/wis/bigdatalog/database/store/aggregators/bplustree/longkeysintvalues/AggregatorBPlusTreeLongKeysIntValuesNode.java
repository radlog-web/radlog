...
public class AggregatorBPlusTreeLongKeysIntValuesNode
	extends AggregatorBPlusTreeNode<AggregatorBPlusTreeLongKeysIntValuesPage, AggregatorBPlusTreeLongKeysIntValuesLeaf> 
	implements AggregatorBPlusTreeLongKeysIntValuesPage, Serializable {
	private static final long serialVersionUID = 1L;

	public long[] keys;
	
	public AggregatorBPlusTreeLongKeysIntValuesNode() { super(); }
			
	public AggregatorBPlusTreeLongKeysIntValuesNode(int nodeSize, AggregateFunctionType aggregateType) {
		super(nodeSize, 8, aggregateType);		
	
		this.highWaterMark = 0;
		this.keys = new long[this.numberOfKeys]; // M-1 keys
		this.children = new AggregatorBPlusTreeLongKeysIntValuesPage[this.getBranchingFactor()]; // M children
	...
	@Override
	public void insert(long key, int data, AggregatorBPlusTreeLongKeysIntValuesInsertResult result) {
		int insertAt = 0;
	...
	private AggregatorBPlusTreeLongKeysIntValuesPage split() {
		AggregatorBPlusTreeLongKeysIntValuesNode rightNode 
			= new AggregatorBPlusTreeLongKeysIntValuesNode(this.nodeSize, this.aggregateType);
