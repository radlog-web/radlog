...
public class BPlusTreeLongKeysByteValuesLeaf 
	extends BPlusTreeGeneralLeaf<BPlusTreeLongKeysByteValuesLeaf> 
	implements BPlusTreeLongKeysByteValuesPage, Serializable {
	private static final long serialVersionUID = 1L;
	
	private long[] keys;
	
	public BPlusTreeLongKeysByteValuesLeaf(int nodeSize, int bytesPerValue) {
		super(nodeSize, 8, bytesPerValue);
	...
	public void insert(long key, byte[] value, BPlusTreeLongKeysByteValuesInsertResult result) {	
		int i;		
	...
	private BPlusTreeLongKeysByteValuesPage split() {
		BPlusTreeLongKeysByteValuesLeaf rightLeaf = new BPlusTreeLongKeysByteValuesLeaf(this.nodeSize, this.bytesPerValue);
	...
	public void get(long startKey, long endKey, BPlusTreeLongKeysByteValuesGetResultRange result) {
		int i;
		for (i = 0; i < this.highWaterMark; i++) {
			//System.out.println("leaf: " + this.keys[i]);
