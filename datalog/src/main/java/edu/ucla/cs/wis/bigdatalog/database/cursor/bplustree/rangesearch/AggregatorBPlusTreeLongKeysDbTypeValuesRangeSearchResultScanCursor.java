...
import edu.ucla.cs.wis.bigdatalog.database.store.aggregators.bplustree.longkeysdbtypevalues.AggregatorBPlusTreeLongKeysDbTypeValuesLeaf;
import edu.ucla.cs.wis.bigdatalog.database.type.DbTypeBase;

public class AggregatorBPlusTreeLongKeysDbTypeValuesRangeSearchResultScanCursor 
	extends AggregatorBPlusTreeLongKeysRangeSearchResultScanCursor<AggregatorBPlusTreeLongKeysDbTypeValuesLeaf> {

	protected DbTypeBase[] values;

	public AggregatorBPlusTreeLongKeysDbTypeValuesRangeSearchResultScanCursor(AggregateRelation relation) {
		super(relation);
	}
...
/*
	...
	*/
	...
	protected int loadTuple(Tuple tuple) {
		return ((AggregatorBPlusTreeLongKeysDbTypeValues)this.storageStructure).loadTuple(this.currentKey, this.values[this.keyIndex], tuple);
	}
