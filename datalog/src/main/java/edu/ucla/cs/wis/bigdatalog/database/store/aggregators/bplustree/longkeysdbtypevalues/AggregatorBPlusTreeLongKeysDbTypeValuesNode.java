...
public class AggregatorBPlusTreeLongKeysDbTypeValuesNode
	extends BPlusTreeNode<AggregatorBPlusTreeLongKeysDbTypeValuesPage, AggregatorBPlusTreeLongKeysDbTypeValuesLeaf> 
	...
	public AggregatorBPlusTreeLongKeysDbTypeValuesNode() { super(); }
	
	public AggregatorBPlusTreeLongKeysDbTypeValuesNode(int nodeSize, DbTypeAggregatorHelper aggregator) {
		super(nodeSize, 8);
		...
		this.children = new AggregatorBPlusTreeLongKeysDbTypeValuesPage[this.getBranchingFactor()]; // M children
	...
	private AggregatorBPlusTreeLongKeysDbTypeValuesPage split() {
		AggregatorBPlusTreeLongKeysDbTypeValuesNode rightNode = new AggregatorBPlusTreeLongKeysDbTypeValuesNode(this.nodeSize, this.aggregator);
