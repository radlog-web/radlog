...
public class AggregatorBPlusTreeLongKeysDbTypeValuesScanCursor extends
		AggregatorBPlusTreeStoreScanCursor<AggregatorBPlusTreeLongKeysDbTypeValues, AggregatorBPlusTreeLongKeysDbTypeValuesLeaf> {

	protected long[] keys;
	protected DbTypeBase[] values;
	
	public AggregatorBPlusTreeLongKeysDbTypeValuesScanCursor(AggregateRelation relation) {
		super(relation);
	}
