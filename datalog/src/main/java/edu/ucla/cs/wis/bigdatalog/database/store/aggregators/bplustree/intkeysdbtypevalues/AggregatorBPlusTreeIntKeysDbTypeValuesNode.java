...
public class AggregatorBPlusTreeIntKeysDbTypeValuesNode
	extends BPlusTreeNode<AggregatorBPlusTreeIntKeysDbTypeValuesPage, AggregatorBPlusTreeIntKeysDbTypeValuesLeaf> 
	...
	public AggregatorBPlusTreeIntKeysDbTypeValuesNode() { super(); }
	
	public AggregatorBPlusTreeIntKeysDbTypeValuesNode(int nodeSize, DbTypeAggregatorHelper aggregator) {
		super(nodeSize, 4);
		...
		this.children = new AggregatorBPlusTreeIntKeysDbTypeValuesPage[this.getBranchingFactor()]; // M children
	...
	private AggregatorBPlusTreeIntKeysDbTypeValuesPage split() {
		AggregatorBPlusTreeIntKeysDbTypeValuesNode rightNode = new AggregatorBPlusTreeIntKeysDbTypeValuesNode(this.nodeSize, this.aggregator);
