...
public class MutualMSNCliqueNode 
	extends MSNCliqueNode 
	implements IMutualClique {
	
	public MutualMSNCliqueNode(String predicateName, NodeArguments args, Binding binding, 
	...
	/*
	@Override
	public MutualMSNCliqueNode copy(ProgramContext programContext) {
		if (programContext.getCliqueMapping().containsKey(this))
			return (MutualMSNCliqueNode) programContext.getCliqueMapping().get(this);
		
		MutualMSNCliqueNode copy = new MutualMSNCliqueNode(new String(this.predicateName), 
