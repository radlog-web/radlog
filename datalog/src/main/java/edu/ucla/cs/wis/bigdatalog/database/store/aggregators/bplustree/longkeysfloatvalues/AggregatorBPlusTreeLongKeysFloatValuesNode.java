...
public class AggregatorBPlusTreeLongKeysFloatValuesNode 
	extends AggregatorBPlusTreeNode<AggregatorBPlusTreeLongKeysFloatValuesPage, AggregatorBPlusTreeLongKeysFloatValuesLeaf> 
	implements AggregatorBPlusTreeLongKeysFloatValuesPage, Serializable {
	private static final long serialVersionUID = 1L;

	protected long[] keys;
	
	public AggregatorBPlusTreeLongKeysFloatValuesNode() { super(); }
	
	public AggregatorBPlusTreeLongKeysFloatValuesNode(int nodeSize, AggregateFunctionType aggregateType) {
		super(nodeSize, 8, aggregateType);
	
		this.highWaterMark = 0;
		this.keys = new long[this.numberOfKeys]; // M-1 keys
		this.children = new AggregatorBPlusTreeLongKeysFloatValuesPage[this.getBranchingFactor()]; // M children
	...
	@Override
	public void insert(long key, double data, AggregatorBPlusTreeLongKeysFloatValuesInsertResult result) {
		int insertAt = 0;
	...
	private AggregatorBPlusTreeLongKeysFloatValuesPage split() {
		AggregatorBPlusTreeLongKeysFloatValuesNode rightNode = new AggregatorBPlusTreeLongKeysFloatValuesNode(this.nodeSize, this.aggregateType);
