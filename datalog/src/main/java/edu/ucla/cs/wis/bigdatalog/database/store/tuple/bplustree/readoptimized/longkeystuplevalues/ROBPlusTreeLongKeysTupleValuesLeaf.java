...
public class ROBPlusTreeLongKeysTupleValuesLeaf 
	extends BPlusTreeLeaf<ROBPlusTreeLongKeysTupleValuesLeaf> 
	implements ROBPlusTreeLongKeysTupleValuesPage, ROBPlusTreeTupleStoreLeaf, Serializable {
	private static final long serialVersionUID = 1L;
	
	protected long[] keys;
	protected Tuple[][] tuples;
	
	public ROBPlusTreeLongKeysTupleValuesLeaf() { super(); }
	
	public ROBPlusTreeLongKeysTupleValuesLeaf(int nodeSize) {
		super(nodeSize, 8);
	...
	private ROBPlusTreeLongKeysTupleValuesPage split() {
		ROBPlusTreeLongKeysTupleValuesLeaf rightLeaf = new ROBPlusTreeLongKeysTupleValuesLeaf(this.nodeSize);
	...
	public MemoryMeasurement getSizeOf() {
		...
		if (this.tuples != null) {
			used += this.highWaterMark * 8; // this is weak
